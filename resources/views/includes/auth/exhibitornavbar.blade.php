<header class="p-3 mb-2 border-bottom">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <a href="{{ route('exhibitor.events.index') }}" class="d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none">
          <img src="{{ asset('images/logo.png') }}" class="me-2" alt="" height="50">
        </a>

        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="{{ route('exhibitor.events.index') }}" class="nav-link px-2 link-dark
          ...
          <li><a href="{{ route('exhibitor.events.download') }}" class="nav-link px-2 link-dark
            {{ Request::is('exhibitor/download') ? "active" : "" }}">Descargar</a></li>
        </ul>
