    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="date" wire:model.defer="date" id="date" class="form-control" aria-describedby="dateHelp">
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input" wire:model.defer="inscription.phone" type="checkbox" id="phone" value="phone" >
            <label class="form-check-label" for="phone">Teléfono</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input" wire:model.defer="inscription.phone" type="checkbox" id="charge" value="charge">
            <label class="form-check-label" for="charge">Cargo</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input" wire:model.defer="inscription.phone" type="checkbox" id="company" value="company">
            <label class="form-check-label" for="company">Empresa</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input" wire:model.defer="inscription.phone" type="checkbox" id="country" value="country">
            <label class="form-check-label" for="country">País</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input" wire:model.defer="inscription.phone" type="checkbox" id="state" value="state">
            <label class="form-check-label" for="state">Provincia</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input" wire:model.defer="inscription.phone" type="checkbox" id="city" value="city">
